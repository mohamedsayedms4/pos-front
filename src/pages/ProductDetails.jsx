    ...
    try {
      ...
      import('jsbarcode').then((JsBarcodeModule) => {
        ...
        idoc.write([
          ...
          '.page{width:' + width + 'mm;height:' + height + 'mm;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:1mm;overflow:hidden;page-break-inside:avoid;padding:1mm 1.5mm;box-sizing:border-box;margin:0 auto;text-align:center;}',
          ...
          '.product-name{font-size:clamp(' + userFontSize + 'px, ' + (height * 0.16).toFixed(1) + 'px, ' + (height * 0.42).toFixed(1) + 'px);font-weight:700;line-height:1.15;margin:0;width:100%;flex:0 0 auto;text-align:center;display:-webkit-box;-webkit-line-clamp:2;-webkit-box-orient:vertical;overflow:hidden;word-break:break-word;}',
          '.product-price{font-size:clamp(' + priceFontSize + 'px, ' + (height * 0.2).toFixed(1) + 'px, ' + (height * 0.48).toFixed(1) + 'px);font-weight:700;line-height:1.1;margin:0;width:100%;flex:0 0 auto;text-align:center;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;}',
          ...
          '.product-code{font-size:clamp(' + skuFontSize + 'px, ' + (height * 0.13).toFixed(1) + 'px, ' + (height * 0.36).toFixed(1) + 'px);font-weight:600;line-height:1.1;margin:0;width:100%;flex:0 0 auto;text-align:center;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;letter-spacing:0.3px;}',
          '.tenant-name{font-size:clamp(' + tenantFontSize + 'px, ' + (height * 0.11).toFixed(1) + 'px, ' + (height * 0.35).toFixed(1) + 'px);font-weight:bold;line-height:1.1;margin:0;width:100%;flex:0 0 auto;text-align:center;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;}',
          '</style></head>',
